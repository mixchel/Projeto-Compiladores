...
prettyStm (Val id Undef e1) = pack "val" <> pack id <> pack "=" <> prettyExp e1 <> pack "\n"
prettyStm (Var id Undef e1) = pack "var" <> pack id <> pack "=" <> prettyExp e1 <> pack "\n"
prettyStm (Val id t e1) = pack "val" <> pack id <> pack ":" <> prettyType t <> pack "=" <> prettyExp e1 <> pack "\n"
prettyStm (Var id t e1) = pack "var" <> pack id <> pack ":" <> prettyType t <> pack "=" <> prettyExp e1 <> pack "\n"
